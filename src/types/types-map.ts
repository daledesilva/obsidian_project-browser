...
import { DEFAULT_PRIORITY_SETTINGS_0_3_0, DEFAULT_PLUGIN_SETTINGS_0_3_0, DEFAULT_STATE_SETTINGS_0_3_0, PrioritySettings_0_3_0, StateSettings_0_3_0, StateViewOrder_0_3_0 } from "./plugin-settings_0_3_0";
import {
    ...
    StateCollectionSettings_0_4_0,
} from "./plugin-settings_0_4_0";

///////////////
///////////////

export interface PluginSettings extends PluginSettings_0_4_0 {}
export const DEFAULT_SETTINGS = DEFAULT_PLUGIN_SETTINGS_0_4_0;
...
export interface ProjectPageStateSettings extends StateCollectionSettings_0_4_0 {}
export const DEFAULT_PROJECT_PAGE_STATE_SETTINGS = DEFAULT_PROJECT_PAGE_STATE_SETTINGS_0_4_0;
export const DEFAULT_PROJECT_PAGE_STATELESS_SETTINGS = DEFAULT_PROJECT_PAGE_STATELESS_SETTINGS_0_4_0;
